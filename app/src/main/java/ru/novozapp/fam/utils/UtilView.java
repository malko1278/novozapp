...
import ru.novozapp.fam.activities.WeatherActivity;
...
public class UtilView {
    ...
    */
    ...
    public static void setNoLollipopPadding(View view, int top, int bottom) {
        if (!isLollipop())    view.setPadding(0, (int) (top * WeatherActivity.density), 0, (int) (bottom * WeatherActivity.density));
    }
    ...
    public static void setViewHeight(View view, float height) {
        view.getLayoutParams().height = (int) (WeatherActivity.density * height);
    }
